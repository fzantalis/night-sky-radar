...
void test_phase_angle_zero_when_sun_is_directly_behind_observer(void) {
    // Sun far along +x, observer at the origin side, satellite between them:
    // the Sun-satellite and observer-satellite directions coincide.
...
int main(int, char**) {
    ...
    RUN_TEST(test_phase_angle_zero_when_sun_is_directly_behind_observer);
